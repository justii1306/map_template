...
int main(void)
{
    ...
    typedef string autor;
    map_template<autor,Biblioteka> DatabaseBiblioteka;

    DatabaseBiblioteka.Add("Fantastyczne zwierzeta",Biblioteka("Justyna Misior","Fantastyka",888,"na polce"));
    DatabaseBiblioteka.Add("Fantastyczne zwierzeta 2",Biblioteka("Justyna Misior","Fantastyka",987,"wyporzyczona"));

    cout << DatabaseBiblioteka << endl;

    map_template<autor,Biblioteka> NewDatabaseBiblioteka = DatabaseBiblioteka;
    Biblioteka* pB;
	pB = NewDatabaseBiblioteka.Find("Fantastyczne zwierzeta 2");
	pB->status = "na polce";

	DatabaseBiblioteka = NewDatabaseBiblioteka;
